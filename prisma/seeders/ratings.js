    ...
    try {
        ...
        for (const property of properties) {
            ...
            for (let i = 0; i < numRatings && usedUserIds.size < users.length; i++) {
                ...
                const comment = reviewOptions[Math.floor(Math.random() * reviewOptions.length)];
                ...
                ratingsData.push({
                    ...
                    rating,
                    comment,
                    ratedAt: new Date(Date.now() - Math.random() * 30 * 24 * 60 * 60 * 1000), // Random date within last 30 days
                });
            }
        }
